...
import 'package:GvApp/screen/extra/politica_privacidad.dart';
import 'package:GvApp/screen/extra/contact_us.dart'; // Asegúrate de importar la pantalla de Contact Us
              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    ...
                    trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                    onTap: () {
                      // Navega a la pantalla de Contact Us
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                  ...
                  ListTile(
                    ...
                    trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                    onTap: () {
                      // Navega a la pantalla de política de privacidad
                      Navigator.push(
                        context,
                        MaterialPageRoute(
